...
class SalesWindow(tk.Frame, ThemeEngine):
    def __init__(self, master):
        ...
        # Heading Label
        heading_label = ttk.Label(customer_details_frame, text="Customer Information",
                                 font="Arial 15 bold", foreground='tomato')
        heading_label.grid(row=0, column=0, padx=30, pady=10) 
        # Customer Name Label and Entry
        cname_label = ttk.Label(customer_details_frame, text="Name",
                                 font="Arial 16 bold")
        ...
        cno_label = ttk.Label(customer_details_frame, text="Mobile No.",
                                 font="Arial 16 bold")
        ...
        heading_label = ttk.Label(options_frame, text="Choice", font=("Arial", 15, "bold"), foreground='tomato')
        heading_label.grid(row=0, column=0, padx=30, pady=10) 

        # Clear all button
        # Clear All Entries, Cart, Selection => Reset everything
        #self.clear_all_btn_img = tk.PhotoImage(file="images/clearall_btn.png")
        clear_all_btn = tk.Button(options_frame, bd=0, bg=self.button_bg, activebackground=self.button_bg,
        ...
        # Heading Label
        heading_label = ttk.Label(selection_frame, text="Products",
                                 font="Arial 15 bold", foreground='tomato')
        heading_label.grid(row=0, column=0, padx=30, pady=10)
        ...
        heading_label = ttk.Label(cart_frame,text="CART", font="Arial 15 bold",foreground='tomato', compound='left')
