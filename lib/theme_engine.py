...
class ThemeEngine:
    ...
    def light_mode(self):
        ...
        self.style.configure('mainframe.TFrame', background='tomato')
        ...
        self.style.configure('TLabel', background='#fff', foreground="tomato")
    ...
    def dark_mode(self):
        ...
        self.style.configure('TEntry', fieldbackground='#3e4451', foreground='#ffffff')
        self.style.map('TEntry', background=[('active', '#49505a')])
        self.style.configure('TButton', background='#1e2128', foreground='#ffffff')