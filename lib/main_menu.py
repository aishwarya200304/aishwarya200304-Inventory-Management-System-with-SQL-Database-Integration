...
class MainMenuWindow(ttk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="MAIN CONTENT",
                                 font="Arial 60 bold", foreground='tomato')
        title_label.pack()
        # Date and Time Label
        ...
        program_title_label = ttk.Label(body_frame, text="Inventory Management System",
                                     font="Arial 45 bold", foreground='tomato')
        ...
        inventory_button = tk.Button(body_frame , text="Events", image=self.inventory_btn_img,
                                 bd=0, bg=self.button_bg, activebackground=self.button_bg,
